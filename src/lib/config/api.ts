  ...
  if (process.env.NODE_ENV === "production" && typeof window !== "undefined") {
    ...
    const fallbackUrls = {
      "/api/chat":
        ...
        "https://your-api-service.vercel.app/api/chat",
      "/api/transcribe":
        process.env.NEXT_PUBLIC_TRANSCRIBE_API_URL ||
        "https://your-api-service.vercel.app/api/transcribe",
      "/api/tts":
        process.env.NEXT_PUBLIC_TTS_API_URL ||
        "https://your-api-service.vercel.app/api/tts",
      "/api/faculty/settings": process.env.NEXT_PUBLIC_API_BASE_URL
        ? `${process.env.NEXT_PUBLIC_API_BASE_URL}/api/faculty/settings`
        : "https://your-api-service.vercel.app/api/faculty/settings",
    };
